...
- ideal local-buckling eigenvalue of approximately 2.13 MN
...
The TTS sits inside the lower portion of the rocket between the propulsion system and the vehicle structure.
...
The individual calculations, member analysis, and joint development were integrated into the current six-strut TTS assembly.

<img src="/assets/images/tts_summer2026_concept.png" alt="Current Citron thrust transfer structure assembly with six tubular struts and compact clevis-style joints" style="width:100%; max-height:700px; object-fit:contain; margin:20px 0;">
...
Reducing the structure to six primary struts created a clearer and more predictable load path without introducing redundant members whose force distribution would depend heavily on:
